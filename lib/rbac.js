...
export const checkPermission = (user, action, resource = null) => {
    ...
    switch (action) {
        ...
        case 'UPLOAD_DOCUMENT':
            return [ROLES.PROJECT_MANAGER, ROLES.ADMIN, ROLES.FINANCE_USER].includes(role);
...
export const canAccessRoute = (user, pathname) => {
    ...
    const routePermissions = {
        ...
        '/finance/dashboard': [ROLES.FINANCE_USER],
        '/finance/manual-entry': [ROLES.FINANCE_USER],
        '/pm': [ROLES.ADMIN, ROLES.PROJECT_MANAGER],
        '/pm/documents': [ROLES.PROJECT_MANAGER, ROLES.FINANCE_USER],
